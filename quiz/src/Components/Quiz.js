    ...
    return (
      <div className="CreateQuiz">
        ...
        {listDekhao && (
          <div>
            <div className="modal">
              <h2>{index >= 10 && "Reasult = " + (result / 10) * 100 + "%"}</h2>
              <Timer
                listDekhao={listDekhao}
                index={index}
                tryAgain={tryAgain}
              />
              {categories.results && index < 10 && (
                <div
                  onChange={(e) => {
                    this.inp(e);
                  }}
              ...
              {index >= 10 && (
                <button
                  onClick={() => {
                    this.setState({ index: 0, tryAgain: true, result: 0 });
                  }}
                >
                  Start Again
                </button>
